            ...
            <div class="col-lg-10 user-form rounded">
                <div class="white-bg border" style="padding:15px;">
                    <div class="text-center">
                        <h1 class="text-heading_vt pb-2">Add Leave Setup</h1>
                    </div>
                    <form id="myform" action="{{ route('save.setup') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="number" id="annualDays" name="annualDays" class="form-control"
                                        placeholder="Enter Number of Days">
                                </div>
                                <h1 class="text-heading_vt pb-1 pt-2">Carry Forward</h1>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" value="1" id="annual_carry_forward"
                                        name="annual_carry_forward" onclick="annualyesCheck();" class="custom-control-input"
                                        checked="">
                                    <label class="custom-control-label" for="annual_carry_forward">Yes</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" value="0" id="no_annual_carry_forward"
                                        name="annual_carry_forward" onclick="annualyesCheck();" class="custom-control-input"
                                        checked="">
                                ...
                                <div id="annual_carry_forward_div" class="pt-2" style="display:none">
                                    <div class="form-group ">
                                        <input type="number" id="annual_forwardDays" name="annual_forwardDays"
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group ">
                                    <label for="title">Days<span class="red"
                                            style="font-size:22px;">*</span></label>
                                    <input type="number" id="casual_numberOfDays" name="casual_numberOfDays"
                                        class="form-control" placeholder="Enter Number of Days">
                                </div>
                                <h1 class="text-heading_vt pb-1 pt-2">Carry Forward</h1>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" value="1" id="casual_carry_forward"
                                        name="casual_carry_forward" onclick="casualyesCheck();"
                                        class="custom-control-input" checked="">
                                    <label class="custom-control-label" for="casual_carry_forward">Yes</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" value="0" id="no_casual_carry_forward"
                                        name="casual_carry_forward" onclick="casualyesCheck();"
                                        class="custom-control-input" checked="">
                                ...
                                <div id="casual_carry_forward_div" class="pt-2" style="display:none">
                                    <div class="form-group ">
                                        <input type="number" id="casual_forwardDays" name="casual_forwardDays"
                                            class="form-control" placeholder="Enter Number of Forwarded Days">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group ">
                                    <label for="title">Days<span class="red"
                                            style="font-size:22px;">*</span></label>
                                    <input type="number" id="sick_leave_numberOfDays" name="sick_leave_numberOfDays"
                                        class="form-control" placeholder="Enter Number of Days">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="form-group ">
                                    <label for="title">Days<span class="red"
                                            style="font-size:22px;">*</span></label>
                                    <input type="number" id="maternity_numberOfDays" name="maternity_numberOfDays"
                                        class="form-control" placeholder="Enter Number of Days">
                                </div>
                            </div>
                        </div>
