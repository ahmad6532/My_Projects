                        ...
                        <table style="background-color: white;">
                            <tr>
                                <td align="center" style="padding: 10px 0 20px;">
                                    <h2><img src="{{ asset('assets/media/misc/mail-champ.png')}}" style="max-width: 15%;"></h2>
                                </td>
                            </tr>
                            <tr>
                                <td class="password-para">
                                    <p>Your account has been created. You may now log in to your account using the credentials provided below.</p>
                                </td>
                            </tr>
                            <tr>
                                <td class="para">
                            ...
                            <tr style="height:60px">
                                <td align="center">
                                    <a href="https://mdm.securegenic.com/" class="visit-btn">Get Started</a>
                                </td>
                            </tr>
                        </table>
                    </td>
