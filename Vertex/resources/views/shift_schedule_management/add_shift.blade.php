...
@section('content')
            ...
            <div class="col-lg-10 user-form rounded">
                <div class="white-bg border" style="padding:15px;">
                    <div class="text-center">
                        <h1 class="text-heading_vt pb-2">Add Shift</h1>
                    </div>
                    <form action="{{ route('save.shift') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group position-relative arrow_vt">
                                    <label for="nameInput" class="form-label">Shift Name<span class="red"
                                            ...
                                            <input type="text" name="shift_name" value="{{ old('shift_name')}}"  id="shift_name"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class=" mb-1 position-relative month-field_vt">
                                        <input type="text" id="basic-timepicker" value="{{ old('start_time')}}" name="start_time" class="form-control" placeholder="Select Time">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">End Time <span class="red"
                                            style="font-size:14px;">*</span></label>
                                    <div class=" mb-1 position-relative month-field_vt">
                                        <input type="text" id="basic-timepicker2" value="{{ old('end_time')}}" name="end_time" class="form-control" placeholder="Select Time">
                                        <i class="fontello icon-clock-1"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Break (Start Time) <span class="red"
                                            style="font-size:14px;">*</span></label>
                                    <div class=" mb-1 position-relative month-field_vt">
                                        <input type="text" id="basic-timepicker3" value="{{ old('break_start_time')}}" name="break_start_time" class="form-control" placeholder="Select Time">
                                        <i class="fontello icon-clock-1"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Break (End Time) <span class="red"
                                            style="font-size:14px;">*</span></label>
                                    <div class=" mb-1 position-relative month-field_vt">
                                        <input type="text" id="basic-timepicker4" value="{{ old('break_end_time')}}" name="break_end_time" class="form-control" placeholder="Select Time">
                                        <i class="fontello icon-clock-1"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="title">Late Time<span class="red"
                                        ...
                                        <div class=" mb-1 position-relative month-field_vt">
                                            <input type="text" id="basic-timepicker5" name="late_time" value="{{old('late_time')}}" class="form-control" placeholder="Select Time">
                                            <i class="fontello icon-clock-1"></i>
                                        </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <input type="number" placeholder="Number Of Hours" name="half_day"  value="{{old('half_day')}}"
                                    class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="textarea1" class="form-label">Add Note<span class="red"
                                            style="font-size:14px;">*</span></label>
                                    <textarea class="form-control" id="textarea1" name="note" rows="3" placeholder="Enter Note"></textarea>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            var start = $('#basic-timepicker').value;
            var end = $('#basic-timepicker1').value;
