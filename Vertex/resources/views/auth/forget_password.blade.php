                ...
                <div class="col-lg-6 col-md-6 col-sm-12 px-0">
                    <div class="height-vt">
                        <div class="login-content-wrape">
                            <div class="login-content border" style="width: 60% !important;">
                                ...
                                <div class="login-content-group mt-4">
                                    @if (session('success'))
                                            ...
                                            background: #afe3af;
                                            padding: 1px 7px;
                                            border-radius: 5px;">{{ session('success') }}</p>
                                    @endif
                                    <form class="form" action="{{ route('send.email.forgetPassword') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="mb-3 checkbox-component-group">
                                            <div class="forgot-link_vt">
                                                    <span style="font-size:12px;">Go back to </span> <a href="{{ url('/') }}">Login</a>
                                            </div>
                                        </div>
                                        <div class="mt-4 text-center mb-4">
                                            <button type="submit" class="login-btn">{{ __('Submit') }} </button>
                                        </div>
                                    </form>
                                </div>
                            </div>
