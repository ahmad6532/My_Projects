                  ...
                  <form class="js-validation-signin" action="{{route('login')}}" method="POST">
                    ...
                    <div class="mb-4">
                      <div class="input-group input-group-lg">
                        <input type="text" class="form-control" id="login-username" value="{{old('email')}}" name="email" placeholder="Email address">
                    ...
                    <div class="d-sm-flex justify-content-sm-between align-items-sm-center text-center text-sm-start mb-0">
                        ...
                        <div class="fw-semibold fs-sm py-1">
                          <a href="reminder" id="hovercolor" class="text-white">Forgot Password?</a>
                        </div>
                        <div class="fw-semibold fs-sm py-1">
                          <a href="signup" id="hovercolor" class="text-white">Register</a>
                        </div>
