@if($type == 'send_email')
    @include('location.be_spoke_forms.actions.email')
...
@elseif($type == 'display_information_to_user') 
    @include('location.be_spoke_forms.actions.user-information')
...
@elseif($type == 'add_user_to_case_manager' ||
    ...
    @include('location.be_spoke_forms.actions.no-action')
@endif