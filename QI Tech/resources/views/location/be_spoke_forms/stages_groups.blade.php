...
<form name="fields_form" method="post" action="{{route('be_spoke_forms_templates.stage_groups.save',$stage->id)}}">
    @csrf
                ...
                <tr>
                    ...
                    <td calss="row_icons">
                        <a class="btn btn-danger delete_group"
                            href="{{route('be_spoke_forms_templates.form_group_delete',['id'=>$group->id,'_token'=>csrf_token()])}}"><i
