<div class="m-t-10 high " data-list="point" id="point-stage-wrapper">
    <h5 class="text-info @if ($nearmiss && $nearmiss->point_of_detection == 'Hidden') fade-slight @endif" style="width: fit-content; display: inline-block; margin: 0;">
        Point of detection? 
    </h5>
@if ($nearmiss && $nearmiss->point_of_detection == 'Hidden') 
    <p class="badge badge-info center" style="display: inline-block; margin: 0;">Hidden</p>
@endif <br>
    <input type="hidden" name="point_of_detection" class="point_of_detection_input" value="Hidden" @if($nearmiss) value="{{$nearmiss->point_of_detection}}" @endif >
        <button @if(!isset($data)) @elseif($data['what']['point_of_detection']['labelling'] == false) style="display: none;" @endif  type="button" class="labelling btn point_of_detection_btn @if($nearmiss && $nearmiss->point_of_detection == 'Labelling') btn-info @else btn-default @endif" data-value="Labelling">{{ $data['what']['point_of_detection']['labelling_text'] ?? 'Labelling' }}</button>
        <button @if(!isset($data)) @elseif($data['what']['point_of_detection']['bagging'] == false) style="display: none;" @endif  type="button" class="bagging btn point_of_detection_btn @if($nearmiss && $nearmiss->point_of_detection == 'Bagging') btn-info @else btn-default @endif" data-value="Bagging">{{ $data['what']['point_of_detection']['bagging_text'] ?? 'Bagging' }}</button>
        <button @if(!isset($data)) @elseif($data['what']['point_of_detection']['filling_away'] == false) style="display: none;" @endif  type="button" class="filling_away btn point_of_detection_btn @if($nearmiss && $nearmiss->point_of_detection == 'Filing Away') btn-info @else btn-default @endif" data-value="Filing Away">{{ $data['what']['point_of_detection']['filling_away_text'] ?? 'Filling Away' }}</button>
        <button @if(!isset($data)) @elseif($data['what']['point_of_detection']['delivering'] == false) style="display: none;" @endif  type="button" class="delivering btn point_of_detection_btn @if($nearmiss && $nearmiss->point_of_detection == 'Delivering') btn-info @else btn-default @endif" data-value="Delivering">{{ $data['what']['point_of_detection']['delivering_text'] ?? 'Delivering' }}</button>
        <button @if(!isset($data)) @elseif($data['what']['point_of_detection']['picking'] == false) style="display: none;" @endif  type="button" class="picking btn point_of_detection_btn @if($nearmiss && $nearmiss->point_of_detection == 'Picking') btn-info @else btn-default @endif" data-value="Picking">{{ $data['what']['point_of_detection']['picking_text'] ?? 'Picking' }}</button>
        <button @if(!isset($data)) @elseif($data['what']['point_of_detection']['final_check'] == false) style="display: none;" @endif  type="button" class="final_check btn point_of_detection_btn @if($nearmiss && $nearmiss->point_of_detection == 'Final Check') btn-info @else btn-default @endif" data-value="Final Check">{{ $data['what']['point_of_detection']['final_check_text'] ?? 'Final Check' }}</button>
        <button @if(!isset($data)) @elseif($data['what']['point_of_detection']['handing_out'] == false) style="display: none;" @endif  type="button" class="handing_out btn point_of_detection_btn @if($nearmiss && $nearmiss->point_of_detection == 'Handing Out') btn-info @else btn-default @endif" data-value="Handing Out">{{ $data['what']['point_of_detection']['handing_out_text'] ?? 'Handing Out' }}</button>
</div>
<style>
    .what_was_error li{
        width: fit-content;
...
<div class="row m-t-10 display_when_point_detection"  >
    ...
    <div class="col-md-3 col-sm-3 col-xs-2 border-right-2">
        <ul class="what_was_error high" data-list="was_error">
    ...
    <div class="col-md-4 col-sm-4 col-xs-4 border-right-2 p-left-50">
        ...
        <div data-list="error_prescription_chks" class="prescription_2nd_column high" @if($nearmiss && $nearmiss->what_was_error != 'Prescription') style="display:none" @endif>
            <label @if(!isset($data)) @elseif(!$data['extra_fields']['prescription']['missing_signature']['hidden']) style="display: none;" @endif class="missing_signature checkbox @if($nearmiss && $nearmiss->prescription_missing_signature) active @endif">
                ...
                <span> {{ $data['extra_fields']['prescription']['missing_signature']['name'] ?? 'Missing signature' }} </span>
            </label>
        ...
        <div data-list="error_labelling_chks" class="high labelling_2nd_column" @if(!$nearmiss || $nearmiss->what_was_error != 'Labelling') style="display:none" @endif >
            <label @if(!isset($data)) @elseif(!$data['extra_fields']['labelling']['wrong_brand']['hidden']) style="display: none;" @endif class="wrong_brand checkbox @if($nearmiss && $nearmiss->labelling_wrong_brand) active @endif">
                ...
                <span>{{ $data['extra_fields']['labelling']['wrong_brand']['wrong_brand_label'] ?? 'Wrong brand' }}</span>
            </label>
            ...
            <label @if(!isset($data)) @elseif(!$data['extra_fields']['labelling']['wrong_item']['hidden']) style="display: none;" @endif class="wrong_item checkbox @if($nearmiss && $nearmiss->labelling_wrong_item) active @endif">
                ...
                <span>{{ $data['extra_fields']['labelling']['wrong_item']['wrong_item_label'] ?? 'Wrong item' }}</span>
            </label>
            <label @if(!isset($data)) @elseif(!$data['extra_fields']['labelling']['wrong_formulation']['hidden']) style="display: none;" @endif class="wrong_formulation checkbox @if($nearmiss && $nearmiss->labelling_wrong_formulation) active @endif">
                ...
                <span>{{ $data['extra_fields']['labelling']['wrong_formulation']['wrong_formulation_label'] ?? "Wrong formulation" }} </span>
            </label>
            ...
            <label @if(!isset($data)) @elseif(!$data['extra_fields']['labelling']['wrong_quantity']['hidden']) style="display: none;" @endif class="wrong_quantity checkbox @if($nearmiss && $nearmiss->labelling_wrong_quantity) active @endif">
                ...
                <span>{{ $data['extra_fields']['labelling']['wrong_quantity']['wrong_quantity_label'] ?? 'Wrong quantity' }}</span>
            </label>
            <label @if(!isset($data)) @elseif(!$data['extra_fields']['labelling']['wrong_strength']['hidden']) style="display: none;" @endif class="wrong_strength checkbox @if($nearmiss && $nearmiss->labelling_wrong_strength) active @endif">
                ...
                <span>{{ $data['extra_fields']['labelling']['wrong_strength']['wrong_strength_label'] ?? 'Wrong strength' }}</span>
            </label>
        </div>
        ...
        <div data-list="error_placing_into_basket_chks" class="high placing_basket_2nd_column" @if(!$nearmiss || $nearmiss->what_was_error != 'Placing into Basket') style="display:none" @endif>
        ...
        <!-- Bagging checkboxes -->
        <div data-list="error_bagging_chks" class="high bagging_2nd_column" @if(!$nearmiss || $nearmiss->what_was_error != 'Bagging') style="display:none" @endif>
        ...
        <div data-list="error_dosette_tray_chks" class="high preparing_dosette_tray_2nd_column" @if(!$nearmiss || $nearmiss->what_was_error != 'Preparing Dosette Tray') style="display:none" @endif>
         ...
         <div data-list="error_handing_out_chks" class="high handing_out_2nd_column" @if(!$nearmiss || $nearmiss->what_was_error != 'Handing Out') style="display:none" @endif>
            <label @if(!isset($data)) @elseif(!$data['extra_fields']['handing_out']['handed_to_wrong_patient']['hidden']) style="display: none;" @endif class="handed_to_wrong_patient checkbox @if($nearmiss && $nearmiss->handing_out_to_wrong_patient) active @endif">
    ...
    <div class="col-md-5 col-sm-5 col-xs-5 third_column">
            ...
            <div class="card-body">
                ...
                <div class="prescription_missing_signature_data prescription_data" @if(!$nearmiss || !$nearmiss->prescription_missing_signature) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;{{ $data['extra_fields']['prescription']['missing_signature']['name'] ?? 'Missing signature' }}</label>
                    </div> 
                </div>
                ...
                <div class="prescription_expired_data  prescription_data" @if(!$nearmiss || !$nearmiss->prescription_expired) style="display:none" @endif>
                    ...
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;{{ $data['extra_fields']['prescription']['prescription_expired']['label'] ?? 'Prescription expired' }}</label>
                    </div>
                ...
                <div class="prescription_old_treatment_data prescription_data" @if(!$nearmiss || !$nearmiss->prescription_old_treatment) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{$data && isset($data['extra_fields']['prescription']['old_treatment']['label']) ? $data['extra_fields']['prescription']['old_treatment']['label'] : 'Old treatment'}}</span></label>
                    </div> 
                </div>
                ...
                <div class="prescription_tampered_data prescription_data" @if(!$nearmiss || !$nearmiss->prescription_tampered) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{$data && isset($data['extra_fields']['prescription']['fraudulent_tampered_prescription']['label']) ? $data['extra_fields']['prescription']['fraudulent_tampered_prescription']['label'] : 'Fraudulent/tampered prescription'}}</span></label>
                    </div> 
                </div>
        ...
        <div class="labelling_3rd_column card card-qi" @if(!$nearmiss || $nearmiss->what_was_error != 'Labelling') style="display:none" @endif>
            <div class="card-body">
                ...
                <br>
                <div data-list="label_wrong_brand_fields" class="high labelling_wrong_brand_data labelling_data" @if(!$nearmiss || !$nearmiss->labelling_wrong_brand) style="display:none" @endif>
                    <div class="checkbox active" style="width: fit-content">
                        <input type="checkbox" class="labelling_wrong_brand_clone" checked>
                        <label>&nbsp;<span>{{ $data['extra_fields']['labelling']['wrong_brand']['wrong_brand_label'] ?? 'Wrong brand' }}</span></label>
                    </div>
                ...
                <div class="labelling_wrong_direction_data labelling_data" @if(!$nearmiss || !$nearmiss->labelling_wrong_direction) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['labelling']['wrong_direction']['wrong_direction_label'] ?? 'Wrong direction' }}</span></label>
                    </div> 
                </div>

            <div data-list="label_wrong_item_fields" class="high labelling_wrong_item_data labelling_data" @if(!$nearmiss || !$nearmiss->labelling_wrong_item) style="display:none" @endif>
                <br>
                <div class="checkbox active" style="width: fit-content;">
                    <input type="checkbox" class="labelling_wrong_item_clone" checked>
                    <label>&nbsp;<span>{{ $data['extra_fields']['labelling']['wrong_item']['wrong_item_label'] ?? 'Wrong item' }}</span></label>
                </div>
            ...
            <div data-list="label_wrong_formulation_fields" class="high labelling_wrong_formulation_data labelling_data" @if(!$nearmiss || !$nearmiss->labelling_wrong_formulation) style="display:none" @endif>
            <br>
            <div class="checkbox active " style="width: fit-content;">
                <input type="checkbox" class="labelling_wrong_formulation_clone" checked>
                <label>&nbsp;<span>{{ $data['extra_fields']['labelling']['wrong_formulation']['wrong_formulation_label'] ?? "Wrong formulation" }} </span></label>
            </div>
                ...
                <div class="labelling_wrong_patient_data labelling_data" @if(!$nearmiss || !$nearmiss->labelling_wrong_patient) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['labelling']['wrong_patient']['wrong_patient_label'] ?? 'Wrong patient' }}</span></label>
                    </div> 
                </div>
                ...
                <div class="labelling_wrong_quantity_data labelling_data" @if(!$nearmiss || !$nearmiss->labelling_wrong_quantity) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['labelling']['wrong_quantity']['wrong_quantity_label'] ?? 'Wrong quantity' }}</span></label>
                    </div> 
                </div>

            <div data-list="label_wrong_strength_fields" class="high labelling_wrong_strength_data labelling_data" @if(!$nearmiss || !$nearmiss->labelling_wrong_strength) style="display:none" @endif>
                <br>
                <div class="checkbox active " style="width: fit-content;">
                    <input type="checkbox" class="labelling_wrong_strength_clone" checked>
                    <label>&nbsp;<span>{{ $data['extra_fields']['labelling']['wrong_strength']['wrong_strength_label'] ?? 'Wrong strength' }}</span></label>
                </div>
        ...
        <div class="picking_3rd_column card card-qi" @if(!$nearmiss || $nearmiss->what_was_error != 'Picking') style="display:none" @endif>
            <div class="card-body">
                ...
                <div class="picking_outdate_item_data picking_data" @if(!$nearmiss || !$nearmiss->picking_out_of_date_item) style="display:none" @endif>
                    ...
                    <div class="checkbox active">
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['picking']['out_of_date_item']['label'] ?? 'Out-of-date item' }}</span></label>
                    </div>
                    <div class="form-group">
            ...
            <div data-list="picking_wrong_brand_fields" class="high picking_wrong_brand_data picking_data" @if(!$nearmiss || !$nearmiss->picking_wrong_brand) style="display:none" @endif>
                <br>
                <div class="checkbox active" style="width:fit-content;" >
                    <input type="checkbox" class="picking_wrong_brand_clone" checked>
                    <label>&nbsp;<span>{{ $data['extra_fields']['picking']['wrong_brand']['label'] ?? 'Wrong brand' }}</span></label>
                </div>
            ...
            <div data-list="picking_wrong_item__fields" class="high picking_wrong_item_data picking_data" @if(!$nearmiss || !$nearmiss->picking_wrong_item) style="display:none" @endif>
                <br>
                <div class="checkbox active" style="width:fit-content;">
                    <input type="checkbox" class="picking_wrong_item_clone" checked>
                    <label>&nbsp;<span>{{ $data['extra_fields']['picking']['wrong_item']['label'] ?? 'Wrong item' }}</span></label>
                </div>
            ...
            <div class="picking_wrong_quantity_data labelling_data" @if(!$nearmiss || !$nearmiss->picking_wrong_quantity) style="display:none" @endif>
                <div class="checkbox">   
                    ...
                    <label>&nbsp;<span>{{ $data['extra_fields']['picking']['wrong_quantity']['label'] ?? 'Wrong quantity' }}</span></label>
                </div> 
            </div>

            <div data-list="picking_wrong_strength_fields" class="high picking_wrong_strength_data picking_data" @if(!$nearmiss || !$nearmiss->picking_wrong_strength) style="display:none" @endif>
                <br>
                <div class="checkbox active" style="width:fit-content;">
        ...
        <div data-list="picking_wrong_formulation_fields" class="high picking_wrong_formulation_data picking_data" @if(!$nearmiss || !$nearmiss->picking_wrong_formulation) style="display:none" @endif>
            <br>
            <div class="checkbox active" style="width:fit-content;">
                <input type="checkbox" class="picking_wrong_formulation_clone" checked>
                <label>&nbsp;<span>{{ $data['extra_fields']['picking']['wrong_formulation']['label'] ?? 'Wrong formulation' }}</span></label>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="placing_basket_another_patient_label_basket_data placing_basket_data" @if(!$nearmiss || !$nearmiss->placing_basket_another_patient_label_basket) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{$data['extra_fields']['placing_to_basket']["another_patient_label_basket"]['label'] ?? ($request->another_patient_label_basket_label ?? 'Another patient\'s labels in/on the basket')}}</span></label>
                    </div> 
                </div>
                ...
                <div class="placing_basket_wrong_basket_data placing_basket_data" @if(!$nearmiss || !$nearmiss->placing_basket_wrong_basket) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{$data['extra_fields']['placing_to_basket']["wrong_basket"]['label'] ?? ($request->wrong_basket_label ?? 'Placed into the wrong basket')}}</span></label>
                    </div> 
                </div>
                ...
                <div class="placing_basket_missing_item_data placing_basket_data" @if(!$nearmiss || !$nearmiss->placing_basket_missing_item) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{$data['extra_fields']['placing_to_basket']["missing_item"]['label'] ?? ($request->missing_item_label ?? 'Missing item')}}</span></label>
                    </div> 
                </div>
                ...
                <div class="placing_basket_label_wrong_item_data placing_basket_data" @if(!$nearmiss || !$nearmiss->placing_basket_label_wrong_item) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{$data['extra_fields']['placing_to_basket']["label_wrong_item"]['label'] ?? ($request->label_wrong_item_label ?? 'Label attached to the wrong item')}}</span></label>
                    </div> 
                </div>
            ...
            <div class="card-body">
                ...
                <div class="bagging_wrong_bag_label_data bagging_data" @if(!$nearmiss || !$nearmiss->bagging_wrong_bag_label) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp; <span>{{ $data['extra_fields']['bagging']['wrong_bag_label']['label'] ?? 'Wrong bag label' }}</span></label>
                    </div> 
                </div>
                ...
                <div class="bagging_another_patient_med_in_bag_data bagging_data" @if(!$nearmiss || !$nearmiss->bagging_another_patient_med_in_bag) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['bagging']['another_patient_med_in_bag']['label'] ?? 'Another patient\'s medication in bag' }}</span></label>
                    </div> 
                </div>
                ...
                <div class="bagging_missed_items_data bagging_data" @if(!$nearmiss || !$nearmiss->bagging_missed_items) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['bagging']['missed_items']['label'] ?? 'Missed out items' }}</span></label>
                    </div> 
                </div>
            ...
            <div class="card-body">
                ...
                <div class="preparing_dosette_tray_wrong_day_time_data preparing_dosette_tray_data" @if(!$nearmiss || !$nearmiss->preparing_dosette_tray_wrong_day_time) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['preparing_dosette_tray']['wrong_day_or_time_of_day']['label'] ?? 'Wrong day/time of day' }}</span></label>
                    </div> 
                </div>
                ...
                <div class="preparing_dosette_tray_error_patient_mar_chart_data preparing_dosette_tray_data" @if(!$nearmiss || !$nearmiss->preparing_dosette_tray_error_patient_mar_chart) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['preparing_dosette_tray']['error_on_patient_mar_chart']['label'] ?? 'Error on patient MAR Chart' }}</span></label>
                    </div> 
                </div>
                ...
                <div class="preparing_dosette_tray_extra_quantity_on_tray_data preparing_dosette_tray_data" @if(!$nearmiss || !$nearmiss->preparing_dosette_tray_extra_quantity_on_tray) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['preparing_dosette_tray']['extra_quantity_in_tray']['label'] ?? 'Extra quantity in tray' }}</span></label>
                    </div> 
                </div>
                ...
                <div class="preparing_dosette_tray_error_in_description_data preparing_dosette_tray_data" @if(!$nearmiss || !$nearmiss->preparing_dosette_tray_error_in_description) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['preparing_dosette_tray']['error_in_description_of_the_medication']['label'] ?? 'Error in description of the medication' }}</span></label>
                    </div> 
                </div>
                ...
                <div class="preparing_dosette_tray_wrong_bag_label_data preparing_dosette_tray_data" @if(!$nearmiss || !$nearmiss->preparing_dosette_tray_wrong_bag_label) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['preparing_dosette_tray']['wrong_bag_label']['label'] ?? 'Wrong bag label' }}</span></label>
                    </div> 
                </div>
                ...
                <div class="preparing_dosette_tray_external_item_missing_data preparing_dosette_tray_data" @if(!$nearmiss || !$nearmiss->preparing_dosette_tray_external_item_missing) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['preparing_dosette_tray']['external_item_missing']['label'] ?? 'External item missing' }}</span></label>
                    </div> 
                </div>
                ...
                <div class="preparing_dosette_tray_tray_item_missing_data preparing_dosette_tray_data" @if(!$nearmiss || !$nearmiss->preparing_dosette_tray_tray_item_missing) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['preparing_dosette_tray']['tray_item_missing']['label'] ?? 'Tray item missing' }}</span></label>
                    </div> 
                </div>
                ...
                <div class="preparing_dosette_tray_error_on_blister_pack_data preparing_dosette_tray_data" @if(!$nearmiss || !$nearmiss->preparing_dosette_tray_error_on_blister_pack) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['preparing_dosette_tray']['preparing_dosette_tray_error_on_blister_pack']['label'] ?? 'Error on blister pack guide sheet' }}</span></label>
                    </div> 
                </div>
            ...
            <div class="card-body">
                ...
                <div class="handing_out_to_wrong_patient_data handing_out_data" @if(!$nearmiss || !$nearmiss->handing_out_to_wrong_patient) style="display:none" @endif>
                    <div class="checkbox">   
                        ...
                        <label>&nbsp;<span>{{ $data['extra_fields']['handing_out']['handed_to_wrong_patient_label'] ?? ($request->handed_to_wrong_patient_label ?? 'Handed to wrong patient') }}</span></label>
                    </div> 
                </div>
