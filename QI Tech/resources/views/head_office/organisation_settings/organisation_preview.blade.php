...
<head>
    ...
    <title>Organisation :: {{env('APP_NAME')}}</title>
    ...
    @if($request->has('logo_file'))
        <style>
        html{
            background-image: url("{{url('data_images/location_brand_request_files/temp/bg').'/'. 'temp.png'}}");
            ...
            <div class="container-fluid custom-background ">
                ...
                <div class="text-center pt-5">
                    <div class="pb-2 text-gray-800">
                        <img src="{{$request->logo_file}}" class="img-fluid img-thumbnail" width="150">
                    </div>
