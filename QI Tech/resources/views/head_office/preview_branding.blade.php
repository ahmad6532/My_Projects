...
<head>
    ...
    <link href="{{route('head_office.color_css')}}?p=1" rel="stylesheet">
        <style>
        

        @if($ho->preview->has_image)
        html{
            background-image: url("{{$ho->preview->bg}}");
            ...
            <div class="container-fluid custom-background ">
                ...
                <div class="text-center pt-5">
                    <div class="pb-2 text-gray-800">
                        <img src="{{$ho->preview->logo}}" class="img-fluid img-thumbnail" width="150">
                    </div>
                    <p class="font-weight-bold">{{ $ho->trading_name }}, {{ $ho->address_line1}},
                        {{ $ho->town}}, {{ $ho->postcode}}</p>
                </div>
