...
@section('top-nav-title', 'Bespoke Form Actions')

@section('content')
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('head_office.be_spoke_form.index')}}">Bespoke Forms</a></li>
        <li class="breadcrumb-item"><a href="{{route('head_office.be_spoke_forms_templates.form_template',$stage->form_id)}}">Form -
                {{substr($stage->form->name,0,30)}} </a></li>
        <li class="breadcrumb-item"><a href="{{route('head_office.be_spoke_forms_templates.form_template',$stage->form_id)}}">Stage
        ...
        <a href="{{route('head_office.be_spoke_forms_templates.form_stage_questions.action',$question->id)}}">Actions</a></li>
    </ol>
</nav>
<div class="card">
    ...
    <div class="card-body">
        ...
        <form name="fields_form" method="post" enctype="multipart/form-data" 
            action="{{route('head_office.be_spoke_forms_templates.form_stage_questions.action.save',$question->id)}}">
            @csrf
            ...
            <div class="table-responsive">
                <table class="table  table-bordered" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a class="btn btn-info" href="{{route('head_office.be_spoke_forms_templates.form_stage_questions.action.edit',[$question->id,$con->id])}}"><i class="fas fa-edit"></i> Edit Condition</a>
                                <a class="btn btn-danger delete_action"
                                    href="{{route('head_office.be_spoke_forms_templates.form_stage_questions.action.condition.delete',['condition_id'=>$con->id,'_token'=>csrf_token()])}}"><i
                ...
                <div class="">
                    ...
                    <div class="form-group"><label for="action_type">Then</label>
                        <select
                            data-href="{{route('head_office.be_spoke_forms_templates.form_stage_questions.action.type_details')}}"
        ...
        <div class="card-body">
            ...
            <div class="action_details">
                ...
                <?php $type = 'send_email' ?>
                @endif
                @include('head_office.be_spoke_forms.action_type')
            </div>
