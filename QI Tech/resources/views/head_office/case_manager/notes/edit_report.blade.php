...
@if(isset($form))
<form action="{{route('case_manager.edit_report_save',$record->id)}}" method="post">
    @csrf
...
?>
    ...
    <div class="card" id="form">
        <div class="card-body" class="s2">
            ...
            @foreach($form->stages as $key=>$stage)
            <div class="card stages stage_{{$stage->id}} stage_data_{{$key+1}}" @if($key !=0) style="display:none"
                @endif>
                <div class="card-body">
