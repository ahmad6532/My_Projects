...
export const TextAreaFormElement: FormElement = {
    ...
    designerBtnElement: {
        icon: (
            ...
            <path d="M18 10H6M21 6H3M21 14H3M18 18H6" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
...
function DesignerComponent({
    ...
    const { removeElement, setSelectedItem,updateElement,selectedItem,setSelectedPageId,setSelectedPage } = useDesigner();
    ...
    return (
        ...
        >
            ...
            <div className="input-area">
                ...
                <textarea className="tex" readOnly disabled>{placeholder}</textarea>
            </div>
    ...
    return (
        ...
        >
            <div className="input-area">
                ...
                <textarea required={required} className="tex" onChange={(e)=> setValue(e.target.value)}
                    onBlur={(e) => {
