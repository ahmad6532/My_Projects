...
<path d="M12 3V6M12 10.5V13.5M12 18V21M22 12H15.5M15.5 12L19.5 16M15.5 12L19.5 8M2 12H8.5M8.5 12L4.5 16M8.5 12L4.5 8" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
...
function DesignerComponent({
    ...
    const { id } = element.extraAttributes;
        ...
        return (
            ...
            <form onChange={handleSubmit(applyChanges)} className="mt-4 mx-auto w-100">
                <Typography variant="body1" color="GrayText">
                    No Propertise for this element
                </Typography>
