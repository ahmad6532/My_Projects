...
<path d="M6 4V20M18 4V20M8 4H4M18 12L6 12M8 20H4M20 20H16M20 4H16" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
...
function DesignerComponent({
    ...
    const { removeElement, setSelectedItem,updateElement,selectedPageId,setSelectedPageId,setSelectedPage} = useDesigner();
...
function FormComponent({
    ...
    return (
        <div
            ...
            style={{paddingBottom:'1px',background:'transparent',boxShadow:'none',paddingLeft:'10px'}}
        >
            <div className="input-area">
                <div>
                    <h3 className="m-0 p-0">
...
function PropertiseComponent({elementInstance}:{
    elementInstance: FormElementInstance}){
        ...
        const {updateElement,elements,setSelectedItem,selectedPageId,selectedItem} = useDesigner();
        ...
        useEffect(() => {
            if (found) {
                reset({id:found.id,title:found.extraAttributes?.title});
            }
        }, [found, reset]);
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <TextField
                            {...field}
                            error={!!errors.title}
                            helperText={errors.title ? "Please enter a valid value" : ''}
                            label="Title"
                            fullWidth
                            variant="outlined"
                            size="small"
