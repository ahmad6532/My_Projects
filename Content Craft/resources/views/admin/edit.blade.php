...
@section('content')
    <form action="{{route('admin.update',$adminData->id)}}" id="editeUser" method="POST" class="w-100 mt-3">
        @csrf
        @method('PUT')
        <div class="w-100 d-flex ">
            <div class="w-50">
                <div class="form-outline mb-3 signup-input-div">
                    ...
                    <input required type="text" name="firstName" class="form-control auth-form " value="{{$adminData->firstName}}" />
            ...
            <div class="w-50">
                <div class="form-outline mb-3 signup-input-div">
                    ...
                    <input required type="text" name="lastName" class="form-control auth-form " value="{{$adminData->lastName}}"  />
                    <i class="fa-regular fa-user"></i>
                </div>
        ...
        <div class="w-100 d-flex ">
            <div class="w-50">
                <div class="form-outline mb-3 signup-input-div">
                    ...
                    <select name="country" value="{{$adminData->country}}"  required class="form-control auth-form single-input">
                        <option value="{{$adminData->country}}">{{$adminData->country}}</option>
        ...
        <div class="d-flex justify-content-end w-100 mb-5">
            <button type="submit" class="btn btn-success auth-submit-btn btn-block" id="updateProfileBtn">Update Profile</button>
        </div>
    </form>
@endsection
