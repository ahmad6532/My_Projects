...
@section('content')
                        ...
                        <div
                            ...
                            <div class="block-content">
                                <div class="scroll scrollPackage">
                                    <form method="post" action="{{route('redeembtn')}}">
                                        @csrf
                                        <table class="table table-vcenter text-white tab-bord1 dataTablePackages"
                                            ...
                                            <form>
                                                <tr class="tab-bord">
                                                    ...
                                                    <td align="center">
                                                        <input type="hidden" name="tpoints" value="{{request()->tpoints}}">
                                                        {{ Request::get('points') }}
                                                    </td>
                                                    <td align="center">
                                                        <input type="hidden" name="amt" value="{{request()->amount}}">
                                                        ${{ Request::get('amount') }}
                                                    </td>
    ...
    @if(session()->has('gone'))
        <script>
            swal("Warning!", "{!! session()->get('gone')!!}", "warning");
        </script>
    @endif
@endsection
