          ...
          <div class="row g-0 justify-content-center bg-black-75">
            <div class="hero-static col-sm-8 col-md-6 col-xl-4 d-flex align-items-center p-2 px-sm-0">
              ...
              <a class="centerLogo" href="index.html">
                ...
                <div class="block-content block-content-full px-lg-5 px-xl-6 py-4 py-md-5 py-lg-6 bg-body-extra-light bg-dark-green other-page-border">
                  <!-- Header -->
                  ...
                  <form class="js-validation-signin" action="{{route('resetPassword')}}" method="POST">
                    @csrf
                      @if(session()->has('pass'))
                          <div class="alert alert-danger errors fw-bold text-center" role="alert">
                              {{ session()->get('pass') }}
                          </div>
                      @endif
                      @csrf
                    ...
                    <div class="mb-4">
                      <div class="input-group input-group-lg">
                        <input type="text" class="form-control" id="login-username" value="{{$email ?? old('email')}}" name="email" placeholder="Email address">
                    ...
                    <div class="mb-4">
                      <div class="input-group input-group-lg">
                        <input type="password" class="form-control" id="login-password" name="password" placeholder="New Password">
                        <span class="input-group-text">
                    ...
                    <div class="mb-4">
                        <div class="input-group input-group-lg">
                          <input type="password" class="form-control" id="login-password" name="password_confirmation" placeholder="Confirm Password">
                          <span class="input-group-text">
                            <i class="fa fa-asterisk"></i>
                          </span>
                        </div>
                    ...
                    <div class="text-center mb-4">
                      <button type="submit" class="btn btn-hero btn-primary btnGreen w-100">
                        <i class="fa fa-fw fa-sign-in-alt opacity-50 me-1"></i> Reset Password
                      </button>
                    </div>
                    <div class="d-sm-flex justify-content-sm-between align-items-sm-center text-center text-sm-start mb-0">
